<div class="text-center">             
          ...
          <?php if(isset($templateParams["errorelogin"])): ?>
            ...
            <?php endif; ?>
          <div class="text-left">
              <form action="processa.php" method="POST" class="reg" enctype="multipart/form-data" required> 
                ...
                <input type="text" id="nome" name="nome" placeholder="Nome" class="registrazione" required/>
                <label for="cognome" class="reglbl">Cognome</label>
                <input type="text" id="cognome" name="cognome" placeholder="Cognome" class="registrazione" required/>
